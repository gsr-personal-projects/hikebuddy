...
static const char *TAG = "board_nvs";

esp_err_t
board_nvs_init(void)
{
	static bool board_nvs_init_done = false;

	if (board_nvs_init_done)
		return ESP_OK;
...
esp_err_t
board_nvs_erase_all(const char* namespace)
{
...
esp_err_t
board_nvs_erase_key(const char* namespace, const char* key)
{
	nvs_handle my_handle;
	esp_err_t err;
...
esp_err_t
board_nvs_get_u8(const char* namespace, const char* key, uint8_t *value)
{
	nvs_handle my_handle;
	esp_err_t err;
...
esp_err_t
board_nvs_set_u8(const char* namespace, const char* key, uint8_t value)
{
	nvs_handle my_handle;
	esp_err_t err;
...
esp_err_t
board_nvs_get_u16(const char* namespace, const char* key, uint16_t *value)
{
	nvs_handle my_handle;
	esp_err_t err;
...
esp_err_t
board_nvs_set_u16(const char* namespace, const char* key, uint16_t value)
{
	nvs_handle my_handle;
	esp_err_t err;
...
esp_err_t
board_nvs_get_str(const char* namespace, const char* key, char *value, size_t *length)
{
	nvs_handle my_handle;
	esp_err_t err;
...
esp_err_t
board_nvs_set_str(const char* namespace, const char* key, const char *value)
{
	nvs_handle my_handle;
	esp_err_t err;
